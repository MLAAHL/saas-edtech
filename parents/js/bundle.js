    ...
    "js/parent.js"() {
      ...
      async function performLookup(sid, skipRegister = false) {
        ...
        try {
          ...
          document.getElementById("studentMeta").textContent = `${currentStudent.stream} \xB7 Semester ${currentStudent.semester}`;
          ...
          txt.textContent = "Search Student";
      ...
      function formatDate(dateStr) {
        return (/* @__PURE__ */ new Date(dateStr + "T00:00:00")).toLocaleDateString("en-IN", { weekday: "short", day: "2-digit", month: "short", year: "numeric" });
      }
      function getPercentClass(p) {
        return p >= 90 ? "excellent" : p >= 75 ? "good" : p >= 60 ? "avg" : "low";
      }
