const fs = require('fs');
let html = fs.readFileSync('e:\\Desktop\\new attendance\\non-teaching\\students.html', 'utf8');
...
// Keep the table and filter specific styles by replacing the huge style block with just what we need
const tableStyles = `
  <style>
    .filters-container {
...
fs.writeFileSync('e:\\Desktop\\new attendance\\non-teaching\\students.html', html);
console.log('Done refactoring students.html');
